...
def animation_SE(file_name):
    ...
    # Configure the axes
    ax1.set_title('Non Linear SE - Numerical Solution')
...
animation_SE("nlse_evolution_plane_wave.dat")

animation_SE("nlse_evolution_wave_packet.dat")


animation_SE("nlse_evolution_solitons.dat")